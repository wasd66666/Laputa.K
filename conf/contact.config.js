...
module.exports = {
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '3779186140@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WHATSAPP: process.env.NEXT_PUBLIC_CONTACT_WHATSAPP || 'LAPUTA-DEFENDER', // 邮箱地址 例如mail@tangly1024.com
